...
import zerozero.opensource.service.GraphSearchService;
...
public class GraphSearchTool {
    ...
    public GraphSearchResult graphSearch(
            @McpToolParam(description = "검색할 고객, 제품, 직원, 부서, 프로젝트 이름 또는 ID입니다.", required = true) String entity,
            @McpToolParam(description = "필터링할 관계 유형입니다. 예: USES, BELONGS_TO, MANAGES_ACCOUNT", required = false) String relation,
            @McpToolParam(description = "탐색 깊이입니다. 기본값은 1이며 최대 2까지 허용합니다.", required = false) Integer depth
    ) {
