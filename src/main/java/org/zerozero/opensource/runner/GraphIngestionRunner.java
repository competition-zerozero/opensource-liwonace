...
import org.zerozero.opensource.config.GraphIngestionProperties;
import org.zerozero.opensource.service.GraphIngestionService;
...
public class GraphIngestionRunner implements ApplicationRunner {
  ...
  public GraphIngestionRunner(
      GraphIngestionProperties properties, GraphIngestionService ingestionService) {
  ...
  public void run(ApplicationArguments args) throws Exception {
    ...
    System.out.println(
        "그래프 데이터 적재 완료: " + result.nodeCount() + "개 node, " + result.edgeCount() + "개 edge");
  }
}
